...
/**
 * Thrown if settings could not be saved for whatever reason.
 */
class SettingsNotSavedException(context: Context) :
    Exception(context.getString(R.string.settings_save_error))
